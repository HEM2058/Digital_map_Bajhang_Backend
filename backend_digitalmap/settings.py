"""
Django settings for backend_digitalmap project.
...
SECRET_KEY = 'django-insecure-4x&3@sjnr45b&h6#afdfe+o7+c+^vj!opuoe=0^q!z*hhlql6v'
...
WSGI_APPLICATION = 'backend_digitalmap.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'gis',  # Replace with your database name
